...
function SidebarTrigger({
  ...
  ref?: React.Ref<ElementRef<typeof Button>>;
}) {
...
function SidebarRail({
  ...
  ref,
  ...props
}: ComponentProps<"button"> & { ref?: React.Ref<HTMLButtonElement> }) {
  const { toggleSidebar } = useSidebar();
...
function SidebarInset({
  ...
  ref,
  ...props
}: ComponentProps<"main"> & { ref?: React.Ref<HTMLDivElement> }) {
  return (
    <main
      className={cn(
...
function SidebarInput({
  ...
  ref?: React.Ref<ElementRef<typeof Input>>;
}) {
  return (
    <Input
      className={cn(
...
function SidebarHeader({
  ...
  ref,
  ...props
}: ComponentProps<"div"> & { ref?: React.Ref<HTMLDivElement> }) {
  return (
    <div
...
function SidebarMenu({
  ...
  ref,
  ...props
}: ComponentProps<"ul"> & { ref?: React.Ref<HTMLUListElement> }) {
  return (
    <ul
